...
namespace PastelariaDoZe.Biblioteca
{
    ...
    public static class Utilitarios
    {
        ...
        public static void SalvaLog(string tipo, string log,int id)
        {
        ...
        /// </summary>
        /// <param name="CPF">String cpf a ser formatada</param>
        /// <param name="cpfBanco">Se o cpf vai para o banco de dados ou não</param>
        /// <returns>Retorna a string cpf formatada</returns>
        public static string FormataCPF(string CPF,bool cpfBanco=false)
        {
            return cpfBanco? CPF.Replace(".","").Replace("-",""):Convert.ToUInt64(CPF).ToString(@"000\.000\.000\-00");
        }

        /// <summary>
        /// Formata uma string Telefone
        /// </summary>
        /// <param name="telefone">string telefone sem formatação</param>
        /// <returns>string telefone formatada</returns>
        /// <example>Recebe '99999999999' e devolve '(99)99999-9999'</example>
